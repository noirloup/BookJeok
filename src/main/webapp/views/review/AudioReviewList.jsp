...
<form id="sss" class = "catebox" action="/bookjeok/racate" method="get">
...
<form id="idform" class="searchform" action="/bookjeok/audiosearch" method="post" >
<% if(location > 0) { %>
...
<h4 align="center" style="font-size:3em">오디오북 리뷰 목록</h4>


<% for(ReviewList r : list) { %>
	<table class = "listbox" align="center" width="600" border="1" cellspacing="0">
	<tr>
		<td rowspan="6" class="usimg"><a href="/bookjeok/rdetaila?booknm=<%= r.getBookNm() %>">
		<img id="audiobookimg" src="/bookjeok/resources/book_img/<%= r.getBookNm() %>.png"></a></td>
		<td colspan="2" class="uslist"><a href="/bookjeok/rdetaila?booknm=<%= r.getBookNm() %>"><%= r.getBookNm() %></a></td>
	</tr>	
	<tr>
