...
<tr>
	<th class="uslistnum">번호</th>
	<th class="uslisttitle">리뷰 제목</th>
	<th class="uslistuser">작성자</th>
	<th class="uslist">첨부파일</th>
	<th class="uslist">날짜</th>
</tr>
<% for(ReviewList r : list){ %>
<tr>
	<td class="uslistnum" align="right"><%= r.getReviewCd() %></td>
	<td class="uslisttitle"><a href="/bookjeok/rdetail.ad?reviewname=<%= r.getReviewName() %>"><%= r.getReviewName() %></a></td>
	<td class="uslistuser" align="center"><%= r.getReviewWriterId() %></td>
	<td class="uslist" align="center">
	...
	<td class="uslist" align="center"><%= r.getReviewRegDate() %></td>
</tr>
<% } %> 
</table>
