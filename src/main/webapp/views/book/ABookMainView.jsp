	      ...
	      success: function(data){
	         ...
	         for(var i = 0, k; i< json.list.length; i++){
					...
					values +="<td><table><tr><th>"
						+ json.list[i].ranking 
						+"</th></tr>"
						+	"<tr><td><a href='/bookjeok/abkdetail?bookid="
						+ json.list[i].bookid + "'>"
						+ "<img src='/bookjeok/resources/book_img/" + json.list[i].bookimg + "'></a></td></tr><tr>"
						+ "<td><a href='/bookjeok/abkdetail?booknm="
						+ json.list[i].booknm + "'>"
						+ json.list[i].booknm 
						+ "</td></tr><tr><td>"
						+ json.list[i].author
	         ...
	         $('#abookbest').html($('#abookbest').html() + values);
	   ...
	   $.ajax({
		      ...
		      success: function(data){
		         ...
		         for(var i = 0, k; i< json.list.length; i++){
	                  ...
	                  values +="<td><table><tr><td><a href='/bookjeok/abkdetail?bookid="
							+ json.list[i].bookid + "'>"
							+ "<img src='/bookjeok/resources/book_img/" + json.list[i].bookimg + "'></a></td></tr><tr>"
							+ "<td><a href='/bookjeok/abkdetail?booknm="
							+ json.list[i].booknm + "'>"
		         ...
		         $('#abooknew').html($('#abooknew').html() + values);
...
<form id="idform" class="searchform" action="/bookjeok/abksearch" method="post">
<div class="searchset" >
...
<h1 class="booktitle" style="width: 300px; margin-top:50px;">오디오북 베스트셀러</h1>
<div class="bookcondiv" id="bookdiv" style="white-space:nowrap; overflow:auto; height:390px;  border:1px solid navy; text-align: center; ">
	<table id="abookbest"   class="allcontentbox" align="center" >

	</table>
</div>

<h1 class="booktitle">오디오북 신규도서</h1>
<div class="bookcondiv" id="bookdiv" style="white-space:nowrap; overflow:auto;  height:770px;  border:1px solid navy; text-align: center;">
	<table id="abooknew"  class="allcontentbox" align="center">
