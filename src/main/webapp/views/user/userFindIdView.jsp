...
<body>
<form action="/bookjeok/ufindid" method="post">
<table align="center">
	<tr>
		<td colspan="2"><h1 style="margin-bottom: 0px; font-size: 28pt;"><img src="/bookjeok/resources/bookjeok/bookjeok.png"><br>아이디 찾기</h1></td>
	</tr>
	<tr>
		<td><table class="findIdForm">
			<tr>
