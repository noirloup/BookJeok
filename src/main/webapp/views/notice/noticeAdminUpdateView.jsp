...
<hr>
<h1 align="center"><%= notice.getNoticeNum() %>번 공지글 수정 페이지</h1>
<br>
<!-- form 에서 입력값들과 파일을 함께 전송하려면
반드시 속성을 추가해야 함 : enctype="multipart/form-data" -->
<form action="/bookjeok/nupdate.ad" method="post" enctype="multipart/form-data">

<input type="hidden" name="no" value="<%= notice.getNoticeNum() %>">	
<input type="hidden" name="ofile" value="<%= notice.getNoticeRenameFile()%>">
<input type="hidden" name="rfile" value="<%= notice.getNoticeOriginalFile() %>">
...
<tr><th>제 목</th><td><input type="text" name="title" size="100" value="<%= notice.getNoticeTitle() %>"></td></tr>
<tr><th>내 용</th><td><textarea rows="5" cols="50" name="content"><%= notice.getNoticeContent() %></textarea></td></tr>
<tr><th colspan="2">
	<input type="submit" value="수정하기"> &nbsp; 
	<input type="reset" value="수정취소"> &nbsp;
	<input type="button" value="목록" onclick="javascript:location.href='/bookjeok/nlist.ad'; return false;">
</th></tr>
</table>
</form>
<br>
