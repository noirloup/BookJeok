...
<form action="/bookjeok/awrite" method="post" enctype="multipart/form-data">
	<table align="center" width="1000" border="1" class = "table">
	
	<tr><th>작성자</th><td><input type="text" name="writer" readonly value="<%= loginUser.getUserId() %>"></td><th>문의</th>
	<td><select name="group">
	<option value = "전체문의" selected ="selected">전체문의</option>
	<option value = "상품문의">상품문의</option>
	<option value = "리뷰문의">리뷰문의</option>
	</select></td></tr>
	<tr><th>제 목</th><td><input type="text" name="title" size="50"><th>첨부파일</th><td><input type="file" name="afile"></td></tr>
