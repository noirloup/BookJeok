...
<form id="idform" class="searchform" action="/bookjeok/usmynmsearch" method="post">
	...
	<tr>
		...
		<td>
			<table class="contentprice">
				<tr><td><a href='/bookjeok/usnmdetail?marketcd=<%= usaushop.getnMarketCd() %>'><input type="text" class="uspricetitle" value="정가"></a></td></tr>
				<tr><td class="usprice"><a href='/bookjeok/usnmdetail?marketcd=<%= usaushop.getnMarketCd() %>'><%= (int)usaushop.getBookPrice() %></a></td></tr>	<!-- 도서 가격 -->
				<tr><td><a href='/bookjeok/usnmdetail?marketcd=<%= usaushop.getnMarketCd() %>'><input type="text" class="usbidtitle" value="판매 가격"></a></td></tr>
				<tr><td class="usbid"><a href='/bookjeok/usnmdetail?marketcd=<%= usaushop.getnMarketCd() %>'><%= usaushop.getPrice() %></a></td></tr>		<!-- 판매 가격 -->
			</table>
		</td>
	</tr>
	</table>
