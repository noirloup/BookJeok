...
<form id="idform" class="searchform" action="/bookjeok/usmybidsearch" method="post">
...
<table align="center" cellspacing="0" cellpadding="0" class="contentbox" style="border: none;">
	...
	<tr>
		<td rowspan="5" class="usimg"><a href='/bookjeok/usaudetail?marketcd=<%= usaushop.getaMarketCd() %>'><img width="100%" id="usimg" src="/bookjeok/resources/book_img/<%= usaushop.getBookimg() %>"></a></td>	<!-- 도서 이미지 -->
		<td class="uslist">
