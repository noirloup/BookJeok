...
<h1 class="newnmtitle" align="center">일반 등록</h1>
<br>
...
<form action="/bookjeok/usnmwrite" method="post" onsubmit="return validate();">
<input type="hidden" name="writerid" value="<%= normalloginUser.getUserId() %>">
...
<table class="usinfo" id="usnminfo" align="center" width="800" cellspacing="5" cellpadding="0">
	<tr><td colspan="4"><h3 class="qualitytitle">품 질</h3></td></tr>
	<tr><td colspan="4" style="padding-left: 3px">
			<div class="usnmquality"><input type="radio" name="usnmquality" value="S" required>S 급</div>
			<div class="usnmquality"><input type="radio" name="usnmquality" value="A" required>A 급</div>
			<div class="usnmquality"><input type="radio" name="usnmquality" value="B" required>B 급</div>
			<div class="usnmquality"><input type="radio" name="usnmquality" value="C" required>C 급</div>
		</td>
	</tr>
	<tr><th width="120px"><h3 class="infotitle">판매 가격</h3></th>
		<td width="265px"><input type="number" class="price" name="price" required></td>
		<th width="120px"><h3 class="infotitle">판매 수량</h3></th>
		<td><input type="number" class="regcount" name="regcount" required></td>
	</tr>
	<tr><th colspan="4" align="left"><h3 class="infotitle">상품 소개</h3></th></tr>
	<tr>
		<td colspan="4">
			<textarea rows="7" cols="70" class="usnmintro" name="usnmintro"></textarea>
		</td>
	</tr>
</table>

<center>
<h3 class="newnotice" style="margin-bottom: 0px;" align="center">장터는 등록하면 정보를 바꿀 수 없습니다.</h3>
<h3 class="newnotice" style="margin-top: 0px; margin-bottom: 5px;" align="center">허위 매물이 되지 않도록, 신중히 작성해주세요.</h3>
<input type="submit" class="newnormalend" value="등록하기">
<input type="reset" class="newnormalend" value="취소하기">
</center>
</form>
