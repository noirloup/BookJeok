...
<form id="idform" class="searchform" action="/bookjeok/usnmcatesearch" method="post">
...
<table align="center" cellspacing="0" cellpadding="0" class="contentbox" style="border: none;">
	...
	<tr>
		<td rowspan="5" class="usimg"><a href='/bookjeok/usnmdetail?marketcd=<%= usaushop.getnMarketCd() %>'>
			<img width="100%" src="/bookjeok/resources/book_img/<%= usaushop.getBookimg() %>">
