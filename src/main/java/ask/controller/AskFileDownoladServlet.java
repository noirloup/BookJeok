...
/**
 * Servlet implementation class NoticeFileDownolad
 */
@WebServlet("/afiledownload")
public class AskFileDownoladServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AskFileDownoladServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전송온 파일명 추출해서 변수에 저장
		String originalFileName = request.getParameter("afile");
		...
		//파일 다운을 위한 response 설정 처리
				...
				response.addHeader("Content-Disposition", "attachment; filename=\""
						+ new String(originalFileName.getBytes("utf-8"), 
								"ISO-8859-1")
						+ "\"");
