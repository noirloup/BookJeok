...
/**
 * Servlet implementation class ReviewAudioSearchServlet
 */
@WebServlet("/audiosearch")
public class ReviewAudioSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewAudioSearchServlet() {
        super();
...
//					System.out.println(location);
					switch (searchtype) {
					case "bookname":
						list = rservice.selectAudioSearchBookName(keyword, location);
						break;
					case "writerid":
						list = rservice.selectAudioSearchWriterId(keyword, location);
						break;
					}
					...
					switch (searchtype) {
					case "bookname":
						list = rservice.selectAudioSearchBookName2(keyword, category);
						break;
					case "writerid":
						list = rservice.selectAudioSearchWriterId2(keyword, category);
						break;
					}
					...
					switch (searchtype) {
					case "bookname":
						list = rservice.selectAudioSearchBookName3(keyword, category, location);
						break;
					case "writerid":
						list = rservice.selectAudioSearchWriterId3(keyword, category, location);
						break;
					}
