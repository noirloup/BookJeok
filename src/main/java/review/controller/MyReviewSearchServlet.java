...
/**
 * Servlet implementation class MyReviewSearchServlet
 */
@WebServlet("/mrsearch")
public class MyReviewSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyReviewSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(list.size() > 0) {
			view = request.getRequestDispatcher("views/review/MyReview.jsp");
