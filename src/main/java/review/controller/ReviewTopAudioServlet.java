...
/**
 * Servlet implementation class ReviewTopAudioServlet
 */
@WebServlet("/rtopaudio")
public class ReviewTopAudioServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewTopAudioServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Review> list = new ReviewService().selectTopAudio();
