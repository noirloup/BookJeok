...
/**
 * Servlet implementation class ReviewTopEbookServlet
 */
@WebServlet("/rtopebook")
public class ReviewTopEbookServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewTopEbookServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Review> list = new ReviewService().selectTopEbook();
