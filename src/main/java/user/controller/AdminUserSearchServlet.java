...
public class AdminUserSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch (action) {
		case "id":
			list = uservice.selectSearchUserId(keyword, startRow, endRow);
			break;
		case "nick":
			list = uservice.selectSearchUserNick(keyword, startRow, endRow);
			break;
		case "gender":
			list = uservice.selectSearchGender(keyword, startRow, endRow);
			break;
		case "age":
			list = uservice.selectSearchAge(Integer.parseInt(keyword), startRow, endRow);
			break;
		}
