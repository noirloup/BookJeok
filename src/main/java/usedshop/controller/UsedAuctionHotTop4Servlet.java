 ...
 */
@WebServlet("/usauhottop")
public class UsedAuctionHotTop4Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UsedAuctionHotTop4Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<UsedShopAuctionSelect> list = new UsedShopService().selectUsedAuctionHotTop4List();
