 ...
 */
@WebServlet("/usnmlowpricetop")
public class UsedNormalLowPriceTop4Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UsedNormalLowPriceTop4Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<UsedShopNormalSelect> list = new UsedShopService().selectUsedNormalLowPriceTop4List();
