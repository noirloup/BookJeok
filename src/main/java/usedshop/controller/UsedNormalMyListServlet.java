...
/**
 * Servlet implementation class UsedNormalMyListServlet
 */
@WebServlet("/usnmmylist")
public class UsedNormalMyListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UsedNormalMyListServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = usservice.getNormalMyListCount(userid);
		...
		list = usservice.selectNormalMyList(userid, startRow, endRow);
		...
		if (list.size() > 0) {
			view = request.getRequestDispatcher("views/usedshop/UsedMyNormalListView.jsp");
