 ...
 */
@WebServlet("/usaucatesearch")
public class UsedAuctionCategorySearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UsedAuctionCategorySearchServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch (searchtype) {
		case "bookname":
			list = usservice.selectAuctionCategorySearchBookName(keyword, category);
			break;
		case "writerid":
			list = usservice.selectAuctionCategorySearchWriterId(keyword, category);
			break;
		}
