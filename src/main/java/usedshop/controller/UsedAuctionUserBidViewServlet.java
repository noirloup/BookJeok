 ...
 */
@WebServlet("/usauuserbidview")
public class UsedAuctionUserBidViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UsedAuctionUserBidViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (usauselect != null) {
			view = request.getRequestDispatcher("views/usedshop/auctionUserBidPop.jsp");
