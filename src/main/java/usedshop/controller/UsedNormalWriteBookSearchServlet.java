 ...
 */
@WebServlet("/usnmwritebooksearsh")
public class UsedNormalWriteBookSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UsedNormalWriteBookSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("bookname") != null) {
			view = request.getRequestDispatcher("views/usedshop/UsedShopNormalWriteView.jsp");
