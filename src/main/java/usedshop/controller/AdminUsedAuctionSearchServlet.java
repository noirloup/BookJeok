 ...
 */
@WebServlet("/usausearch.ad")
public class AdminUsedAuctionSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminUsedAuctionSearchServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = usservice.getAuctionListCount();;
		...
		switch (action) {
		case "bookname":
			list = usservice.selectAuctionSearchBookName(keyword, startRow, endRow);
			break;
		case "writerid":
			list = usservice.selectAuctionSearchWriterId(keyword, startRow, endRow);
			break;
		}
