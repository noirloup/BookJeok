 ...
 */
@WebServlet("/usnmsearch.ad")
public class AdminUsedNormalSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminUsedNormalSearchServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = usservice.getNormalListCount();;
		...
		switch (action) {
		case "bookname":
			list = usservice.selectNormalSearchBookName(keyword, startRow, endRow);
			break;
		case "writerid":
			list = usservice.selectNormalSearchWriterId(keyword, startRow, endRow);
			break;
		}
